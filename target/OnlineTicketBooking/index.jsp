				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<p>Copyright @Neiza <a href="#">Module</a>. All Rights Reserved. <br>Made with <i class="icon-heart3"></i> by <a href="http://freehtml5.co/" target="_blank">Freehtml5.co</a> / Demo Images: <a href="https://unsplash.com/" target="_blank">Unsplash</a></p>
						</div>
					</div>
				</div>
			</div>
